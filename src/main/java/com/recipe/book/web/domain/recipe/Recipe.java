...
public class Recipe implements Ownable<User> {
    @Id
    ...
    @Formula("(SELECT count(*) > 0 FROM Recommendation r WHERE r.owner_id = owner_id)")
    ...
    public static Recipe create(String title, List<String> thumbnails, String content) {
